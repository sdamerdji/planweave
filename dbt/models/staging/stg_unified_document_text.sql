...
select
  ...
  'legistar' || ':' || legistar_client || ':' || legistar_event_id as unified_document_id,
...
select
  ...
  'prime_gov' || ':' || prime_gov_client || ':' || prime_gov_document_id as unified_document_id,
  substring(text, 1, 5000) as truncated_text,
...
select
  ...
  'civic_plus' || ':' || city_name || ':' || document_id as unified_document_id,
  substring(text, 1, 5000) as truncated_text,
  document_url as document_url
